import { Body, Param, Controller, Post, Delete, Get, Put, UseGuards } from "@nestjs/common"
import { ApiBearerAuth, ApiTags } from "@nestjs/swagger"
import { WorkSpaceService } from "./workSpace.service"
import {
	CreateWorkSpaceDto,
	GetWorkSpaceDto,
	GetWorkSpaceInformationDto,
	UpdateWorkSpaceDto,
...
export class WrokSpaceController {
	...
	@Put("/:workSpaceId")
	updateWorkSpaceDetail(@Param() params: GetWorkSpaceDto, @Body() body: UpdateWorkSpaceDto) {
		return this.workSpaceService.update(params.workSpaceId, body)
	}

	@Delete("/:workSpaceId")
	deleteWorkSpace(@Param() params: GetWorkSpaceDto) {
